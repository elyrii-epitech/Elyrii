                ...
                border: Border.all(
                  color: _isTextFieldFocused
                      ...
                      : (isDark 
                          ...
                          : AppColors.borderLight.withValues(alpha: 0.4)), // Bordure plus subtile
                  width: 1.5,
                ),
                boxShadow: [
                  BoxShadow(
                    color: isDark
                        ...
                        : AppColors.primary.withValues(alpha: 0.05), // Ombre colorée très subtile
                    blurRadius: 12,
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  ...
                  AppColors.primary.withValues(alpha: 0.7), // Gradient plus doux
                ],
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: const Icon(
                    Icons.arrow_upward_rounded, // Flèche vers le haut plus moderne
                    color: Colors.white,
                    size: 24,
                  ),
                ),
