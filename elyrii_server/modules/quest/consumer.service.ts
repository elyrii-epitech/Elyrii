import { questConsumer as consumer } from "../../config/kafka.config";
import QuestRepository from "../../repository/quest.repository";

const questRepository = new QuestRepository();

export async function initQuestConsumers() {
    await consumer.subscribe({ topic: "elyrii.ai.quest-proposals", fromBeginning: false });
